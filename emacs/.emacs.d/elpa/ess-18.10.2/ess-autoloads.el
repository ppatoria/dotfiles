...
(fn &optional ALIST PROC-NAME IS-DERIVED)")
...
ESS[BUGS]: Major mode for BUGS." t)
...
(fn &optional ESS-START-ARGS CUSTOMIZE-ALIST NO-WAIT)" t)
...
ESS[JAGS]: Major mode for JAGS." t)
...
See `ess-noweb-mode' and `R-mode' for more help." t)
...
(fn BEG END EVEN-IF-READ-ONLY)" t)
